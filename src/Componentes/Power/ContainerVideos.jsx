...
function ContainerVideos() {
  return (
    ...
    <><br></br><><h2 class="font-dmsans sm:text-4xl text-2xl font-bold title-font text-center text-transparent bg-clip-text bg-gradient-to-r from-primarytext to-black mb-12 mt-6">Para <span class="text-amber-500 xl:inline"> Postulantes </span>
