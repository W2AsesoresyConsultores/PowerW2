...
function HeaderPower() {
  ...
  return (
    <header
      className={`bg-powercolorblue w-full z-10 h-[72px] flex justify-between md:justify-around items-center fixed top-0 transition-transform duration-300 ${
    ...
    >
      <div className="mx-auto w-full px-4 flex justify-between md:justify-around items-center">
        <Link className="text-white" to="/">
          <img
            className="w-28"
            src="https://elcuvegbwtlngranjtym.supabase.co/storage/v1/object/public/AssetsPower/Main/logo%20power%20en%20positivo.png"
            alt="Logo"
          />
        </Link>
        ...
        <div className="hidden md:flex font-inter items-center">
          <Link
            to="/AdminLogin"
            className="text-md font-semibold border border-white hover:bg-[#eef2fa] hover:text-powercolorblue transition-colors duration-200 text-white px-6 py-2 rounded-full ml-4 font-inter"
          >
            Reclutador
          </Link>
          <Link
            to="/Login"
            className="text-md font-semibold hover:bg-[#ececec] bg-white text-powercolorblue transition-colors duration-200 px-6 py-2 rounded-full ml-4 font-inter"
          >
            Candidato
          </Link>
        </div>
