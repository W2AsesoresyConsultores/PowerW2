...
const EmpresaSelectorEdit = ({ onEmpresaChange, empresaSeleccionada }) => {
    ...
    const handleChange = (event) => {
        const selectedEmpresa = empresas.find(emp => emp.nombre_empresa === event.target.value);
...
export default EmpresaSelectorEdit;