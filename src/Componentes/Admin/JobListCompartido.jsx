...
import JobsContextCompartido from '../../Context/JobsContextCompartido';
...
const Compartido = () => {
  const { userSearchResults: jobs, setJobs, userId } = useContext(JobsContextCompartido);
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      const id_empresa = perfilData.id_empresa;
